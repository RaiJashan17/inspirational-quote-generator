...
async function updateQuoteDDBObject() {
    ...
    try{
        ...
        console.log('error updatingg quote object in DynamoDB', error)
    }
}
        ...
        const svgImage=`
          <svg width="${width}" height="${height}">
              <style>
                  ...
                  <text x="${width / 2}" y="${
                height - 10
              }" class="footerStyles">Developed by @raijashan17 | Quotes from ZenQuotes.io</text>
              </svg>       
          `;
          
          const backgroundImages = [
              "Backgrounds/Cool Sky.png",
              "Backgrounds/Kye Meh.png",
              "Backgrounds/Wedding Day Blues.png",
              "Backgrounds/Witching Hour.png"
          ];
